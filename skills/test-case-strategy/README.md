...
- Provides reusable references for unit, property-based, integrated PBT, integration, contract, and E2E test decisions.
...
- `references/`: Focused guides for unit drift checks, property-based tests, integrated PBT, integration tests, contract tests, and E2E tests.

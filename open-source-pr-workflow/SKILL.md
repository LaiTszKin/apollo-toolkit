...
- If the PR includes code changes, run `fix-edge-cases` first.
...
- If code changes exist, run `fix-edge-cases` and `code-simplifier` in that order before opening the PR.

...
function toolExamples(...examples) {
  return examples;
}
...
const TOOL_COMMANDS = [
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You know the incident time range and want only the matching log slice.',
      ],
      insteadOf: [
        'Searching the full log file when the main problem is time scoping.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need to find recurring messages, IDs, stack traces, or regex matches inside logs.',
      ],
      insteadOf: [
        'Filtering by time alone when you already know the error text or pattern to match.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need spoken output, subtitle timing, or a voiceover pipeline for docs and scripts.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need a spec-first workflow before implementing a user-visible or risky change.',
      ],
      insteadOf: [
        'Starting implementation before a spec path exists when planning is required.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need verified inline or display math output for Markdown, HTML, or generated documents.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You already have JSON error-book content and need a rendered PDF artifact.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need to publish a confirmed problem, proposal, docs gap, security issue, or observability issue to GitHub.',
      ],
      insteadOf: [
        'Hand-building issue bodies inline in shell commands when rich Markdown could be corrupted by quoting.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need picture outputs under the storyboard workflow rather than a generic one-off image.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need to discover candidate issues before reading one in detail.',
      ],
      insteadOf: [
        'Opening a single issue directly when you first need to search or filter the issue list.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You already know the issue number and want its full context.',
      ],
      insteadOf: [
        'Listing issues when you already have the exact issue you need to inspect.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need to inspect PR review feedback or close addressed review threads.',
      ],
      insteadOf: [
        'Using generic PR commands when the task is specifically about review threads.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You already have a video file and need a controlled resize or crop step.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need a lightweight PDF text extraction fallback on macOS.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need the last conversation set before generating or refreshing Codex memory artifacts.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need to sync the AGENTS.md memory index to match the latest memory files.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You need recent session input for the learn-skill-from-conversations workflow.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You changed `SKILL.md` frontmatter or want a catalog-wide metadata validation pass.',
      ],
      examples: toolExamples(
        {
  ...
  },
  {
    ...
    help: {
      ...
      useWhen: [
        'You changed skill agent configs or need a catalog-wide agent-config validation pass.',
      ],
      examples: toolExamples(
        {
...
function buildToolOverview(name) {
  const tool = getToolCommand(name);
  if (!tool) {
    return null;
  }
...
function buildToolExamples(name) {
  const tool = getToolCommand(name);
  if (!tool || !tool.help?.examples?.length) {
    return '';
  }
...
function buildToolDiscoveryHelp() {
